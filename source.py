...
#Implemented in object oriented programming inorder to add multiple images
class DragImg():
    def __init__(self, path, posOrigin, imgType):
        ...
        self.size = self.img.shape[:2]  #gives the height and width
...
while True:
    ...
    if hands:
        ...
        # Check if clicked
        #to check if the index finger is near the image
